...
package com.horstmann.collection {
  object Main extends App {
    val fred = new sec03.com.horstmann.impatient.people.Person("Fred")
    val wilma = new sec03.com.horstmann.impatient.people.Person("Wilma")
    val barney = new sec03.com.horstmann.impatient.people.Person("Barney")
    fred.friends += wilma
    fred.friends += barney
