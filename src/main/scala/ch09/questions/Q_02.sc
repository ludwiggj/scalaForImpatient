...
val source = Source.fromFile("./src/main/scala/ch09/questions/02_tabbedTextIn.txt", "UTF-8")
val n = 14
...
val out = new PrintWriter("./src/main/scala/ch09/questions/02_tabbedTextOut.txt")
