...
object Main extends App {
  ...
  val fred = new ch07.lectures.sec02.com.horstmann.impatient.Employee(50000)
  fred.giveRaise(10)
  println(fred + ": " + fred.description)

  val wilma = new ch07.lectures.sec02.com.horstmann.impatient.Manager
  wilma.subordinates += fred
  wilma.subordinates += new ch07.lectures.sec02.com.horstmann.impatient.Employee(50000)
  println(wilma + ": " + wilma.description)
}
}