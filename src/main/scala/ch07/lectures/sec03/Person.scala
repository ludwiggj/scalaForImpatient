...
package com.horstmann.collection {
  object Main extends App {
    val fred = new ch07.lectures.sec03.com.horstmann.impatient.people.Person("Fred")
    val wilma = new ch07.lectures.sec03.com.horstmann.impatient.people.Person("Wilma")
    val barney = new ch07.lectures.sec03.com.horstmann.impatient.people.Person("Barney")
    fred.friends += wilma
    fred.friends += barney
