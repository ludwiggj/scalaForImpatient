...
val attempt1 = "ls -al .." #> new File("./ch09/lectures/output.txt") !  // output to file

val attempt2 = "ls -al .." #>> new File("./ch09/lectures/output.txt") ! // append to file

val read = "grep scala" #< new File("./ch09/lectures/output.txt") !
