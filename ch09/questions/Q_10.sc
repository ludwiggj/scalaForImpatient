...
val out = new ObjectOutputStream(new FileOutputStream("./ch09/questions/09_people.obj"))
out.writeObject(circleOfFriends)
out.close()
val in = new ObjectInputStream(new FileInputStream("./ch09/questions/09_people.obj"))
